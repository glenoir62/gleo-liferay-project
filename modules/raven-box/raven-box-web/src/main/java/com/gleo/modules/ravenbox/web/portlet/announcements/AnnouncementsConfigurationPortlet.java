 ...
 *
 */
@Component(immediate = true, property = { "com.liferay.portlet.css-class-wrapper=announcements-configuration-portlet",
	"com.liferay.portlet.display-category=category.hidden", "com.liferay.portlet.icon=/ravenbox/icons/icon.png",
	"com.liferay.portlet.render-weight=50", "com.liferay.portlet.scopeable=true",
	"com.liferay.portlet.use-default-template=true", "com.liferay.portlet.add-default-resource=true",
	"javax.portlet.display-name=Announcements configuration", "javax.portlet.expiration-cache=0",
...
//	PortletURL redirectURLPortlet = PortalUtil.getLiferayPortletResponse(renderResponse).createLiferayPortletURL(
//		themeDisplay.getPlid(), PortletKeys.ANNOUNCEMENT_DISPLAY_PORTLETID, PortletRequest.RENDER_PHASE, false);
