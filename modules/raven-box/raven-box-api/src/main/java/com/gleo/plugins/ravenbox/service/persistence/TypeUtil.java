...
public class TypeUtil {
	...
	*/
	public static Type findByGroupId_First(long groupId,
		OrderByComparator<Type> orderByComparator)
		throws com.gleo.plugins.ravenbox.exception.NoSuchTypeException {
