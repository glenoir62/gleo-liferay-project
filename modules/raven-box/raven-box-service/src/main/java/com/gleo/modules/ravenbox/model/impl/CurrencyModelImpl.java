...
import com.gleo.modules.ravenbox.model.CurrencyModel;
import com.gleo.modules.ravenbox.model.CurrencySoap;
...
/**
 * The base model implementation for the Currency service. Represents a row in the &quot;ravenbox_Currency&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class CurrencyModelImpl extends BaseModelImpl<Currency>
	 ...
	 */
	public static final String TABLE_NAME = "ravenbox_Currency";
	...
	public static final String TABLE_SQL_CREATE = "create table ravenbox_Currency (currencyId LONG not null primary key,companyId LONG,label VARCHAR(75) null,symbol VARCHAR(75) null,order_ INTEGER,countryId LONG,rate LONG)";
	public static final String TABLE_SQL_DROP = "drop table ravenbox_Currency";
	public static final String ORDER_BY_JPQL = " ORDER BY currency.order DESC";
	public static final String ORDER_BY_SQL = " ORDER BY ravenbox_Currency.order_ DESC";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.gleo.ravenbox.web.service.util.PropsUtil.get(
				"value.object.entity.cache.enabled.com.gleo.modules.ravenbox.model.Currency"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.gleo.ravenbox.web.service.util.PropsUtil.get(
				"value.object.finder.cache.enabled.com.gleo.modules.ravenbox.model.Currency"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.gleo.ravenbox.web.service.util.PropsUtil.get(
				"value.object.column.bitmask.enabled.com.gleo.modules.ravenbox.model.Currency"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.gleo.ravenbox.web.service.util.PropsUtil.get(
				"lock.expiration.time.com.gleo.modules.ravenbox.model.Currency"));
	...
	public String toXmlString() {
		...
		sb.append("com.gleo.modules.ravenbox.model.Currency");
