...
import com.gleo.plugins.ravenbox.model.AnnouncementModel;
import com.gleo.plugins.ravenbox.model.AnnouncementSoap;
...
/**
 * The base model implementation for the Announcement service. Represents a row in the &quot;ravenbox_Announcement&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class AnnouncementModelImpl extends BaseModelImpl<Announcement>
	 ...
	 */
	public static final String TABLE_NAME = "ravenbox_Announcement";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.gleo.ravenbox.web.service.util.PropsUtil.get(
				"value.object.entity.cache.enabled.com.gleo.plugins.ravenbox.model.Announcement"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.gleo.ravenbox.web.service.util.PropsUtil.get(
				"value.object.finder.cache.enabled.com.gleo.plugins.ravenbox.model.Announcement"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.gleo.ravenbox.web.service.util.PropsUtil.get(
				"value.object.column.bitmask.enabled.com.gleo.plugins.ravenbox.model.Announcement"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.gleo.ravenbox.web.service.util.PropsUtil.get(
				"lock.expiration.time.com.gleo.plugins.ravenbox.model.Announcement"));
	...
	public String toXmlString() {
		...
		sb.append("com.gleo.plugins.ravenbox.model.Announcement");
