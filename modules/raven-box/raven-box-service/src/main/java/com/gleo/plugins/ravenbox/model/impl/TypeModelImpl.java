...
import com.gleo.plugins.ravenbox.model.TypeModel;
import com.gleo.plugins.ravenbox.model.TypeSoap;
...
public class TypeModelImpl extends BaseModelImpl<Type> implements TypeModel {
	...
	public static final String TABLE_SQL_CREATE = "create table ravenbox_Type (typeId LONG not null primary key,name STRING null,groupId LONG,companyId LONG,order_ INTEGER)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.gleo.ravenbox.web.service.util.PropsUtil.get(
				"value.object.entity.cache.enabled.com.gleo.plugins.ravenbox.model.Type"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.gleo.ravenbox.web.service.util.PropsUtil.get(
				"value.object.finder.cache.enabled.com.gleo.plugins.ravenbox.model.Type"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.gleo.ravenbox.web.service.util.PropsUtil.get(
				"value.object.column.bitmask.enabled.com.gleo.plugins.ravenbox.model.Type"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.gleo.ravenbox.web.service.util.PropsUtil.get(
				"lock.expiration.time.com.gleo.plugins.ravenbox.model.Type"));
	...
	public String toXmlString() {
		...
		sb.append("com.gleo.plugins.ravenbox.model.Type");
