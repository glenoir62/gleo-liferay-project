...
public class TypeServiceHttp {
	public static com.gleo.modules.ravenbox.model.Type addType(
		HttpPrincipal httpPrincipal, com.gleo.modules.ravenbox.model.Type type,
		...
		try {
			MethodKey methodKey = new MethodKey(TypeServiceUtil.class,
					"addType", _addTypeParameterTypes0);
			...
			return (com.gleo.modules.ravenbox.model.Type)returnObj;
		}
	...
	public static com.gleo.modules.ravenbox.model.Type updateType(
		...
		try {
			MethodKey methodKey = new MethodKey(TypeServiceUtil.class,
					"updateType", _updateTypeParameterTypes1);
	...
	public static com.gleo.modules.ravenbox.model.Type deleteType(
		...
		try {
			MethodKey methodKey = new MethodKey(TypeServiceUtil.class,
					"deleteType", _deleteTypeParameterTypes2);
	...
	public static java.util.List<com.gleo.modules.ravenbox.model.Type> getTypesByGroupId(
		...
		try {
			MethodKey methodKey = new MethodKey(TypeServiceUtil.class,
					"getTypesByGroupId", _getTypesByGroupIdParameterTypes3);
			...
			return (java.util.List<com.gleo.modules.ravenbox.model.Type>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	private static final Class<?>[] _updateTypeParameterTypes1 = new Class[] {
			com.gleo.modules.ravenbox.model.Type.class
		};
	private static final Class<?>[] _deleteTypeParameterTypes2 = new Class[] {
