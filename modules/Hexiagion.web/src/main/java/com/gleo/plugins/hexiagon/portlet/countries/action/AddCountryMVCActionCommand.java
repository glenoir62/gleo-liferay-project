...
@Component(
	property = {
		...
		"mvc.command.name=addCountry"
	},
	service = MVCActionCommand.class
)
public class AddCountryMVCActionCommand
	extends BaseMVCActionCommand {

	
	/**
	 * AddCountryMVCActionCommand Logger.
	 */
	protected static Log LOGGER = LogFactoryUtil.getLog(AddCountryMVCActionCommand.class);
	...
	protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
		...
		try {
			country = ExtCountryServiceUtil.addCountry(isActive, isZipRequired, name, a2, a3, number, idd);
