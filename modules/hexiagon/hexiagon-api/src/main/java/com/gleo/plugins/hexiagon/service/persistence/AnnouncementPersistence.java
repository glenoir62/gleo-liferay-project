 ...
 * @see com.gleo.plugins.hexiagon.service.persistence.impl.AnnouncementPersistenceImpl
...
public interface AnnouncementPersistence extends BasePersistence<Announcement> {
	...
	*/
	public java.util.List<Announcement> filterFindByGroupId(long groupId);
	...
	* @return the matching announcements that the user has permission to view
	*/
	public java.util.List<Announcement> filterFindByG_S(long groupId, int status);
	...
	* @return the range of matching announcements that the user has permission to view
	*/
	public java.util.List<Announcement> filterFindByG_S(long groupId,
